...
function getProductIdsForCart(profileItems) {
  ...
  var productTypes = profileItems.product_types || []; // The population of onboarding.productTypes only happens if the task list should be shown
  ...
  productTypes.forEach(function (productType) {
    if (onboarding.productTypes[productType] && onboarding.productTypes[productType].product && (includeInstalledItems || !onboarding.installedPlugins.includes(onboarding.productTypes[productType].slug))) {
